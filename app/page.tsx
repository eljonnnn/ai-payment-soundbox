        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              This application demonstrates instant payment notifications using Supabase Realtime
              and the Web Speech API. Merchants receive audio alerts the moment customers complete payments.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-green-50 border-2 border-green-200 rounded-xl p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Listen for incoming payments with real-time audio notifications
                </p>
            ...
            <div className="bg-yellow-50 border-2 border-yellow-200 rounded-xl p-6 mb-8">
              ...
              <ol className="text-left text-sm text-gray-700 space-y-2">
                <li className="flex items-start">
                  ...
                  <span>Configure <code className="bg-white px-2 py-1 rounded">.env.local</code> with Supabase credentials</span>
                </li>
                <li className="flex items-start">
                  <span className="font-semibold mr-2">2.</span>
                  <span>Run <code className="bg-white px-2 py-1 rounded">npx prisma migrate dev</code></span>
                </li>
                <li className="flex items-start">
                  <span className="font-semibold mr-2">3.</span>
                  <span>Execute SQL commands from <code className="bg-white px-2 py-1 rounded">supabase-setup.md</code></span>
                </li>
                <li className="flex items-start">
                  <span className="font-semibold mr-2">4.</span>
                  <span>Run <code className="bg-white px-2 py-1 rounded">npx prisma db seed</code></span>
                </li>
              </ol>
            </div>
